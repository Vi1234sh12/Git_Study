# Created By Vishal Dhanure    [ 22/10/2020 ]

 what is Git ?
--> git is distrucuted revision version and opensource code management system with an emphasis on speed.git was initially designed and devopled by linux  torvalds for the linux kernel devoplement . git is a free software distributed under the terms of the  Gnu ( general public licence version 2.

#Version control system(VCS)
 is a software that helps software devoplers to work together maintain a complete history of their work.

Listed below the function of vcs
*allow devopers to work simulatanously
*does not allow overwritten each's changes.
*maintains a history of every version
* centralized version control system(cvcs)
* Distrbuted / Decenteralized version control system

 # Distributed version control system
Centralized version control system uses a central server to store all files and enable team collaboration . But the major drawback of cvcs is its single point of failures, i.e failure of the central server . unfortunately if the central server goes down for an hour , then during that hour, no one can collaborate at all. And even in a worste  caseif the disk of the central server gets corrupted and proper backup has not been taken, then you will lose the entire history of the project. Here, distributed version control system (DVCS) comes into picture.
